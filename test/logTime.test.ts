...
const { executeLogTime } = await import('../src/tools/logTime.js');

describe('executeLogTime', () => {
  beforeEach(() => {
  ...
  it('posts payload as-is when no task_id is provided', async () => {
    ...
    expect(continuumClient.post).toHaveBeenCalledWith('u1', '/logged-hours/', {
      project_id: 5,
      hours: 1.5,
      description: 'work',
      date: '2026-06-09T12:00:00Z',
